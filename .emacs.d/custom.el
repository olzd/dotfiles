(custom-set-variables
 ...
 '(haskell-mode-hook (quote (el-get-ghc-mod-hook el-get-haskell-hook turn-on-haskell-doc-mode capitalized-words-mode imenu-add-menubar-index structured-haskell-mode)))
